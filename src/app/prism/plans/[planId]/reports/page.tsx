      ...
      <div className="max-w-content mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">Generate branded PDF reports for client delivery.</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {REPORT_TYPES.map((type) => (
              <button
                ...
                className="bg-white rounded-xl border border-gray-200 p-6 text-left hover:shadow-md hover:border-indigo-200 transition-all group"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">{type.pageCount}</p>
          ...
          <div className="grid grid-cols-12 gap-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                <div className="px-6 py-4 border-b flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-sm font-semibold text-gray-900">{selectedReportType.name}</h2>
                      <p className="text-xs text-gray-500">{selectedReportType.pageCount}</p>
                    </div>
                  </div>
                  <button
                  ...
                  <div className="space-y-2">
                    {selectedReportType.sections.map((section) => (
                      ...
                      >
                        ...
                        {section.required && (
                          <span className="text-[10px] text-gray-400 bg-gray-200 px-1.5 py-0.5 rounded">Required</span>
                        )}
                      </label>
                    ))}
                  </div>
            ...
            <div className="col-span-4 space-y-4">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                <h3 className="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-3">Branding</h3>
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="text-xs text-gray-500 block mb-1">Firm Logo</label>
                    <div className="border-2 border-dashed border-gray-200 rounded-lg p-3 text-center text-xs text-gray-400 cursor-pointer hover:border-gray-300">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-xs text-gray-600">Include compliance disclosures</span>
                  </label>
                </div>
              </div>
              ...
              {/* Delivery */}
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                <h3 className="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-3">Delivery</h3>
                <div className="space-y-2">
                  {[
              ...
              <button
                ...
                className="w-full px-4 py-3 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {isGenerating ? (
                  <>
                ...
                return (
                  <div key={report.id} className="px-6 py-4 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-gray-50 flex items-center justify-center">
                      {type?.icon || <FileText size={20} className="text-gray-400" />}
                    </div>
                    <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <button className="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" title="Preview">
                        <Eye size={16} />
                      </button>
                      <button className="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" title="Download">
                        <Download size={16} />
                      </button>
                      <button className="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" title="Email">
                        <Mail size={16} />
                      </button>
                      <button className="p-2 text-gray-400 hover:text-red-600 rounded-lg hover:bg-red-50 transition-colors" title="Delete">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
