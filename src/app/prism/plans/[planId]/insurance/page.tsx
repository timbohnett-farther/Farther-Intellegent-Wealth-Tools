...
import { Shield, Plus, Umbrella } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-xl font-bold text-text">Insurance</h1>
            </div>
        ...
        <div className="bg-surface-soft rounded-xl border border-border-subtle shadow-sm p-8">
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <div className="w-12 h-12 rounded-full bg-accent-primary/10 flex items-center justify-center mb-4">
              <Umbrella size={24} className="text-accent-primarySoft" />
            </div>
            <h3 className="text-sm font-semibold text-text mb-1">No insurance policies added yet</h3>
