      ...
      <div className="max-w-content mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-xl font-bold text-charcoal-900">Income Sources</h1>
            </div>
        ...
        <div className="bg-white rounded-xl border border-limestone-200 shadow-sm p-8">
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h3 className="text-sm font-semibold text-charcoal-900 mb-1">No income sources added yet</h3>
