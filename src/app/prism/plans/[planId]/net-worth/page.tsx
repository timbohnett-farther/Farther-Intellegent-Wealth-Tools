    ...
    <div>
      ...
      <div className="max-w-content mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-xl font-bold text-charcoal-900">Net Worth & Accounts</h1>
            </div>
        ...
        <div className="bg-white rounded-xl border border-limestone-200 shadow-sm p-5 mb-6">
          <h3 className="font-semibold text-charcoal-900 mb-4">Tax Bucket Summary</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-lg border border-limestone-100 bg-limestone-50 p-4 text-center">
              <p className="text-xs font-medium text-charcoal-500 mb-1">Taxable</p>
              <p className="text-lg font-bold text-charcoal-900" style={{ fontFeatureSettings: '"tnum"' }}>$0</p>
            </div>
            <div className="rounded-lg border border-limestone-100 bg-limestone-50 p-4 text-center">
              <p className="text-xs font-medium text-charcoal-500 mb-1">Tax-Deferred</p>
              <p className="text-lg font-bold text-charcoal-900" style={{ fontFeatureSettings: '"tnum"' }}>$0</p>
            </div>
            <div className="rounded-lg border border-limestone-100 bg-limestone-50 p-4 text-center">
              <p className="text-xs font-medium text-charcoal-500 mb-1">Tax-Free</p>
              <p className="text-lg font-bold text-charcoal-900" style={{ fontFeatureSettings: '"tnum"' }}>$0</p>
            </div>
          </div>
        </div>
        ...
        {/* Asset List */}
        <div className="bg-white rounded-xl border border-limestone-200 shadow-sm p-8 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-charcoal-900">Assets</h3>
          </div>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center mb-4">
              <PiggyBank size={24} className="text-emerald-400" />
            </div>
            <h3 className="text-sm font-semibold text-charcoal-900 mb-1">No assets added yet</h3>
        ...
        <div className="bg-white rounded-xl border border-limestone-200 shadow-sm p-8">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-charcoal-900">Liabilities</h3>
          </div>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-sm font-semibold text-charcoal-900 mb-1">No liabilities added yet</h3>
            <p className="text-sm text-charcoal-500 max-w-sm">
