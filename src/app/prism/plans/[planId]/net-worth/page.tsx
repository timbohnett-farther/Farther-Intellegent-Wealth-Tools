    ...
    <div>
      ...
      <div className="max-w-content mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Landmark size={20} className="text-teal-300" />
              <h1 className="text-xl font-bold text-white">Net Worth & Accounts</h1>
            </div>
        ...
        <div className="bg-white/[0.07] rounded-xl border border-white/[0.06] shadow-sm p-5 mb-6">
          <h3 className="font-semibold text-white mb-4">Tax Bucket Summary</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-lg border border-limestone-100 bg-transparent p-4 text-center">
              <p className="text-xs font-medium text-white/50 mb-1">Taxable</p>
              <p className="text-lg font-bold text-white" style={{ fontFeatureSettings: '"tnum"' }}>$0</p>
            </div>
            <div className="rounded-lg border border-limestone-100 bg-transparent p-4 text-center">
              <p className="text-xs font-medium text-white/50 mb-1">Tax-Deferred</p>
              <p className="text-lg font-bold text-white" style={{ fontFeatureSettings: '"tnum"' }}>$0</p>
            </div>
            <div className="rounded-lg border border-limestone-100 bg-transparent p-4 text-center">
              <p className="text-xs font-medium text-white/50 mb-1">Tax-Free</p>
              <p className="text-lg font-bold text-white" style={{ fontFeatureSettings: '"tnum"' }}>$0</p>
            </div>
          </div>
        </div>
        ...
        {/* Asset List */}
        <div className="bg-white/[0.07] rounded-xl border border-white/[0.06] shadow-sm p-8 mb-6">
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-sm font-semibold text-white mb-1">No assets added yet</h3>
        ...
        <div className="bg-white/[0.07] rounded-xl border border-white/[0.06] shadow-sm p-8">
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-sm font-semibold text-white mb-1">No liabilities added yet</h3>
            <p className="text-sm text-white/50 max-w-sm">
