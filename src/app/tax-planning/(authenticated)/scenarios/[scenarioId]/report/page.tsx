...
export default function ReportPreviewPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 bg-canvas">
        <div className="h-8 w-48 rounded bg-limestone-200 animate-pulse" />
        <div className="h-12 rounded-lg bg-limestone-200 animate-pulse" />
        <div className="rounded-lg border border-limestone-200 bg-white p-6 shadow-sm space-y-3">
          <div className="h-4 w-40 rounded bg-limestone-200 animate-pulse" />
          <div className="h-4 w-56 rounded bg-limestone-200 animate-pulse" />
          <div className="h-4 w-48 rounded bg-limestone-200 animate-pulse" />
        </div>
        <div className="h-[400px] rounded-lg bg-limestone-200 animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 bg-canvas">
      ...
      {/* Page title */}
      <h1 className="text-2xl font-bold text-charcoal-900">Scenario Report</h1>
      ...
      <div className="rounded-lg border border-limestone-200 bg-white p-6 shadow-sm">
        ...
        <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div>
            <dt className="text-xs font-medium uppercase tracking-wide text-charcoal-500">
              Scenario Name
            </dt>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative group">
          <button
            ...
            disabled
            className="inline-flex h-10 items-center gap-2 rounded-lg bg-brand-700 px-5 text-sm font-medium text-white opacity-50 cursor-not-allowed"
          >
            <svg
              className="h-4 w-4"
              fill="none"
          ...
          <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden rounded-lg bg-charcoal-900 px-3 py-1.5 text-xs text-white shadow-lg group-hover:block whitespace-nowrap">
            Coming in Stage 2
          </span>
        </div>
        ...
        <button
          ...
          className="inline-flex h-10 items-center gap-2 rounded-lg border border-limestone-200 bg-white px-5 text-sm font-medium text-charcoal-700 hover:bg-limestone-50 transition-colors"
        >
          <svg
            className="h-4 w-4"
            fill="none"
