...
function StatCardSkeleton() {
  return (
    <div className="rounded-lg border border-limestone-200 bg-white p-6 shadow-sm animate-pulse">
      ...
      <div className="h-8 w-16 rounded bg-limestone-200" />
    </div>
  );
}
    ...
    <div className="space-y-3">
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="flex items-center gap-3 animate-pulse">
          <div className="h-8 w-8 rounded-full bg-limestone-200" />
          <div className="flex-1">
            <div className="h-4 w-3/4 rounded bg-limestone-200 mb-1" />
            <div className="h-3 w-1/3 rounded bg-limestone-200" />
          </div>
        </div>
      ))}
    </div>
...
function getActivityIcon(type: RecentActivity['type']): React.ReactNode {
  ...
  switch (type) {
    case 'household':
      return (
        <svg className={`${base} text-brand-700`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-lg border border-limestone-200 bg-white p-6 shadow-sm">
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex w-full items-center gap-3 rounded-lg border border-limestone-200 px-4 py-3 text-left transition-colors hover:border-brand-300 hover:bg-brand-50/30"
            >
              ...
              <div>
                <p className="text-sm font-medium text-charcoal-900">Upload Return</p>
                <p className="text-xs text-charcoal-500">Upload a new tax return PDF</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-charcoal-900">Create Household</p>
                <p className="text-xs text-charcoal-500">Set up a new household</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-charcoal-900">View All Households</p>
                <p className="text-xs text-charcoal-500">Browse and manage households</p>
              </div>
            </button>
          </div>
        </div>
        ...
        {/* Recent Activity */}
        <div className="lg:col-span-2 rounded-lg border border-limestone-200 bg-white p-6 shadow-sm">
          ...
          {loading ? (
            ...
            <div className="py-8 text-center">
              <svg className="mx-auto h-10 w-10 text-charcoal-300 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            ...
            <ul className="space-y-3">
              {recentActivity.map((activity) => (
                <li
                  key={activity.id}
                  className="flex items-center gap-3 rounded-lg px-3 py-2 transition-colors hover:bg-limestone-50"
                >
