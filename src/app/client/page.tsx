  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-sm text-text-muted bg-surface-soft border border-border-subtle rounded-lg px-4 py-3">
          ...
          <a
            ...
            className="flex items-center gap-1 hover:text-accent-primarySoft"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Plan Success Rate */}
        <div className="bg-surface-soft rounded-card border border-border-subtle p-5 flex items-center gap-4">
          <SuccessGauge value={KPI.planSuccessRate} />
          <div>
            <div className="text-sm text-text-muted">Plan Success Rate</div>
      ...
      <div className="bg-linear-to-r from-brand-50 to-white border border-brand-100 rounded-card p-6">
        ...
        <p className="text-text-muted leading-relaxed">
          ...
          <span className="font-bold text-accent-primarySoft">
          ...
          {ACTION_ITEMS.map((action) => {
            ...
            return (
              <button
                ...
                className="bg-surface-soft rounded-card border border-border-subtle p-5 text-left hover:border-accent-primarySoft hover:shadow-sm transition-all"
              >
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-lg bg-accent-primary/10 flex items-center justify-center flex-shrink-0">
                    <Icon size={20} className="text-accent-primarySoft" />
                  </div>
