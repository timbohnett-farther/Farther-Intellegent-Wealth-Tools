    ...
    <div className="space-y-4">
      ...
      <div className="card overflow-hidden">
        ...
        <div className="divide-y divide-limestone-100">
          ...
          <div className="flex justify-between px-4 py-3 text-sm bg-critical-50 font-semibold">
            <span className="text-critical-700">Total Tax on Liquidation</span>
            <span className="text-critical-700">{formatCurrency(data.totalTax)}</span>
          </div>
          <div className="flex justify-between px-4 py-2.5 text-sm">
            <span className="text-charcoal-500">Net After-Tax Proceeds</span>
      ...
      <div className="card p-4">
        ...
        <p className="text-xs text-charcoal-500 mb-3">To receive the requested net amount, you must sell more to cover taxes.</p>
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center p-3 bg-orange-50 rounded-lg">
            <p className="text-xs text-charcoal-500 mb-1">Must Sell (Gross-Up)</p>
          ...
          <div className="text-center p-3 bg-critical-50 rounded-lg">
            <p className="text-xs text-charcoal-500 mb-1">Total Tax on Gross-Up</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-limestone-50 border-b">
                <th className="text-left px-4 py-2 font-medium text-charcoal-500">Cost Component</th>
                <th className="text-right px-4 py-2 font-medium text-critical-500">Sell Assets</th>
                <th className="text-right px-4 py-2 font-medium text-brand-700">Box Spread</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-t border-limestone-100">
                ...
                <td className="px-4 py-2 text-right text-brand-700">$0</td>
              </tr>
              <tr className="border-t border-limestone-100">
              ...
              <tr className="border-t-2 border-limestone-300 bg-limestone-50 font-semibold">
                ...
                <td className="px-4 py-2 text-right text-brand-700">{formatCurrency(data.totalCostComparison.borrowTotal)}</td>
              </tr>
              <tr className="bg-success-50 font-bold">
                <td className="px-4 py-2 text-success-700">Net Advantage of Borrowing</td>
                <td className="px-4 py-2 text-right"></td>
                <td className="px-4 py-2 text-right text-success-700">{formatCurrency(data.totalCostComparison.netAdvantage)}</td>
              </tr>
            </tbody>
          </table>
        </div>
