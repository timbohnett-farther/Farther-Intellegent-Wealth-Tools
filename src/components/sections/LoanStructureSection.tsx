  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card p-4">
        ...
        <div className="bg-gradient-to-r from-brand-50 to-brand-100 rounded-lg p-4">
          <div className="grid grid-cols-2 gap-4 text-center">
            <div className="bg-white rounded-lg p-3 shadow-sm border border-brand-100">
              <p className="text-xs text-charcoal-500 mb-1">Bull Call Spread</p>
            ...
            <div className="bg-white rounded-lg p-3 shadow-sm border border-brand-100">
              <p className="text-xs text-charcoal-500 mb-1">Bear Put Spread</p>
              <div className="text-sm">
          ...
          <div className="mt-3 text-center">
            <p className="text-xs text-charcoal-500">Strike Width: {data.strikeWidth} points | Multiplier: ${data.multiplier} | Contracts: {data.contracts}</p>
          </div>
        </div>
      </div>
      ...
      <div className="card overflow-hidden">
        ...
        <div className="divide-y divide-limestone-100">
          ...
          <div className="flex justify-between px-4 py-3 text-sm bg-brand-50 font-semibold">
            <span className="text-brand-700">All-In Borrowing Rate</span>
            <span className="text-brand-700">{formatPercent(data.allInRate)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="card p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="text-center p-3 bg-success-50 rounded-lg">
            <p className="text-xs text-charcoal-500 mb-1">Proceeds Received</p>
          ...
          <div className="text-center p-3 bg-critical-50 rounded-lg">
            <p className="text-xs text-charcoal-500 mb-1">Repayment Due</p>
            <p className="text-lg font-bold text-critical-700">{formatCurrency(data.actualRepayment)}</p>
          </div>
          <div className="text-center p-3 bg-limestone-50 rounded-lg">
            <p className="text-xs text-charcoal-500 mb-1">Interest Paid</p>
            <p className="text-lg font-bold text-charcoal-700">{formatCurrency(data.interestPaid)}</p>
          </div>
        </div>
