    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="card p-3 text-center">
          <p className="text-xs text-text-muted">Initial Margin</p>
        ...
        <div className="card p-3 text-center">
          <p className="text-xs text-text-muted">Max Decline to MC</p>
        ...
        <div className="card p-3 text-center">
          <p className="text-xs text-text-muted">MC Trigger Value</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-transparent border-b">
                <th className="text-left px-3 py-2 font-medium text-text-muted">Decline</th>
                <th className="text-right px-3 py-2 font-medium text-text-muted">Portfolio Value</th>
                <th className="text-right px-3 py-2 font-medium text-text-muted">Box Obligation</th>
                <th className="text-right px-3 py-2 font-medium text-text-muted">Equity</th>
                <th className="text-right px-3 py-2 font-medium text-text-muted">Equity %</th>
                <th className="text-center px-3 py-2 font-medium text-text-muted">Status</th>
                <th className="text-right px-3 py-2 font-medium text-text-muted">Excess Equity</th>
              </tr>
            </thead>
            <tbody>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-transparent border-b">
                ...
                <th className="text-right px-3 py-2 font-medium text-text-muted">Decline</th>
                <th className="text-center px-3 py-2 font-medium text-text-muted">Duration</th>
                <th className="text-center px-3 py-2 font-medium text-text-muted">Margin Call?</th>
              </tr>
            </thead>
            <tbody>
