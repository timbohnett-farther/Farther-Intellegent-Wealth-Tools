  ...
  return (
    <div className="card p-6">
      <div className="flex items-center justify-between mb-3">
        <h4 className="text-sm font-semibold text-white/60">Compliance Documentation</h4>
        <button
          onClick={() => {
            navigator.clipboard.writeText(profile.complianceNotes);
          }}
          className="text-xs text-teal-300 hover:text-teal-300 flex items-center gap-1"
        >
      ...
      <div className="p-4 bg-transparent rounded-lg text-xs text-white/60 leading-relaxed whitespace-pre-wrap font-mono">
      ...
      <div className="mt-3 flex items-center gap-2">
        ...
        <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-semibold bg-teal-500/15 text-teal-300">Reg BI</span>
        <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-semibold bg-teal-500/15 text-teal-300">CFA Framework</span>
      </div>

      {/* Disclosures */}
      <div className="mt-4 p-3 bg-white/[0.06] rounded-lg text-[10px] text-white/30 space-y-1 leading-relaxed">
