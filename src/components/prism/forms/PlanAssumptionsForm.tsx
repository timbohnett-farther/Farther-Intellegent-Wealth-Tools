...
export function PlanAssumptionsForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Expected Returns</h3>
          <p className="mt-0.5 text-sm text-text-muted">Long-term nominal return assumptions by asset class.</p>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Inflation</h3>
          <p className="mt-0.5 text-sm text-text-muted">Annual inflation rate assumptions.</p>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Monte Carlo Simulation</h3>
          <p className="mt-0.5 text-sm text-text-muted">Parameters for probability-based projections.</p>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Social Security</h3>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Life Expectancy</h3>
        </div>
