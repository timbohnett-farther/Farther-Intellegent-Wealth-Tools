    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      {isInvestmentAccount(accountType) && (
        <div className="rounded-lg border border-limestone-200 bg-limestone-50 p-4 space-y-4">
          <h4 className="text-sm font-medium text-charcoal-700">Investment Details</h4>
          ...
          <div>
            <p className="mb-2 text-sm font-medium text-charcoal-700">
              Asset Allocation <span className="font-normal text-charcoal-500">(must total 100%)</span>
            </p>
      ...
      {isEmployerPlan(accountType) && (
        <div className="rounded-lg border border-limestone-200 bg-limestone-50 p-4 space-y-4">
          <h4 className="text-sm font-medium text-charcoal-700">Employer Plan Details</h4>
      ...
      {isLiability(accountType) && (
        <div className="rounded-lg border border-limestone-200 bg-limestone-50 p-4 space-y-4">
          <h4 className="text-sm font-medium text-charcoal-700">Liability Details</h4>
      ...
      {isRealEstate(accountType) && (
        <div className="rounded-lg border border-limestone-200 bg-limestone-50 p-4 space-y-4">
          <h4 className="text-sm font-medium text-charcoal-700">Real Estate Details</h4>
