    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <section>
        <div className="mb-4">
          ...
          <p className="mt-0.5 text-sm text-text-muted">Basic identifying information for the client.</p>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Contact Information</h3>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Employment</h3>
        </div>
      ...
      <section>
        <div className="mb-4">
          <h3 className="text-base font-semibold text-text">Planning</h3>
        </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <Tooltip content="Age at which the financial plan ends">
                <button type="button" className="text-text-faint hover:text-text-muted">
