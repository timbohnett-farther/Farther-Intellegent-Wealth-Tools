...
function StrategyCard({
  ...
  return (
    ...
    >
      {/* Recommended badge */}
      {isRecommended && (
        <div className="absolute -top-2.5 left-4 inline-flex items-center gap-1 rounded-full bg-accent-primary px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-text">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="rounded-md bg-transparent p-3">
          <div className="flex items-center gap-1.5 mb-0.5">
            <DollarSign className="h-3 w-3 text-text-faint" />
        ...
        <div className="rounded-md bg-transparent p-3">
          <div className="flex items-center gap-1.5 mb-0.5">
            <CheckCircle2 className="h-3 w-3 text-text-faint" />
            <span className="text-[10px] font-medium uppercase tracking-wide text-text-muted">
              Alignment
            </span>
          </div>
...
export function TaxTransitionPanel({ analysis }: TaxTransitionPanelProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-brand-200 bg-accent-primary/5 p-4">
        <div className="flex items-start gap-2">
          <Star className="mt-0.5 h-4 w-4 shrink-0 text-accent-primarySoft" />
          <div>
            <span className="text-xs font-semibold text-accent-primarySoft uppercase tracking-wide">
              Recommendation Rationale
            </span>
