...
export const FEDERAL_RULES_2025_V1: any = {
  ...
  ordinaryBrackets: {
    single: [
      { lowerBound: 0, upperBound: 11600, rate: 0.10, baseAmount: 0 },
      { lowerBound: 11600, upperBound: 47150, rate: 0.12, baseAmount: 0 },
      { lowerBound: 47150, upperBound: 100525, rate: 0.22, baseAmount: 0 },
      { lowerBound: 100525, upperBound: 191950, rate: 0.24, baseAmount: 0 },
      { lowerBound: 191950, upperBound: 243725, rate: 0.32, baseAmount: 0 },
      { lowerBound: 243725, upperBound: 609350, rate: 0.35, baseAmount: 0 },
      { lowerBound: 609350, upperBound: null, rate: 0.37, baseAmount: 0 },
    ],
    married_filing_jointly: [
      { lowerBound: 0, upperBound: 23200, rate: 0.10, baseAmount: 0 },
      { lowerBound: 23200, upperBound: 94300, rate: 0.12, baseAmount: 0 },
      { lowerBound: 94300, upperBound: 201050, rate: 0.22, baseAmount: 0 },
      { lowerBound: 201050, upperBound: 383900, rate: 0.24, baseAmount: 0 },
      { lowerBound: 383900, upperBound: 487450, rate: 0.32, baseAmount: 0 },
      { lowerBound: 487450, upperBound: 731200, rate: 0.35, baseAmount: 0 },
      { lowerBound: 731200, upperBound: null, rate: 0.37, baseAmount: 0 },
    ],
    married_filing_separately: [
      ...
      { lowerBound: 100525, upperBound: 191950, rate: 0.24, baseAmount: 0 },
      { lowerBound: 191950, upperBound: 243725, rate: 0.32, baseAmount: 0 },
      { lowerBound: 243725, upperBound: 365600, rate: 0.35, baseAmount: 0 },
      { lowerBound: 365600, upperBound: null, rate: 0.37, baseAmount: 0 },
    ],
    head_of_household: [
      { lowerBound: 0, upperBound: 16550, rate: 0.10, baseAmount: 0 },
      { lowerBound: 16550, upperBound: 63100, rate: 0.12, baseAmount: 0 },
      { lowerBound: 63100, upperBound: 100500, rate: 0.22, baseAmount: 0 },
      { lowerBound: 100500, upperBound: 191950, rate: 0.24, baseAmount: 0 },
      { lowerBound: 191950, upperBound: 243700, rate: 0.32, baseAmount: 0 },
      { lowerBound: 243700, upperBound: 609350, rate: 0.35, baseAmount: 0 },
      { lowerBound: 609350, upperBound: null, rate: 0.37, baseAmount: 0 },
    ],
  ...
  capitalGainBrackets: {
    single: [
      { lowerBound: 0, upperBound: 47025, rate: 0.00, baseAmount: 0 },
      { lowerBound: 47025, upperBound: 518900, rate: 0.15, baseAmount: 0 },
      { lowerBound: 518900, upperBound: null, rate: 0.20, baseAmount: 0 },
    ],
    married_filing_jointly: [
      { lowerBound: 0, upperBound: 94050, rate: 0.00, baseAmount: 0 },
      { lowerBound: 94050, upperBound: 583750, rate: 0.15, baseAmount: 0 },
      { lowerBound: 583750, upperBound: null, rate: 0.20, baseAmount: 0 },
    ],
    married_filing_separately: [
      { lowerBound: 0, upperBound: 47025, rate: 0.00, baseAmount: 0 },
      { lowerBound: 47025, upperBound: 291850, rate: 0.15, baseAmount: 0 },
      { lowerBound: 291850, upperBound: null, rate: 0.20, baseAmount: 0 },
    ],
    head_of_household: [
      { lowerBound: 0, upperBound: 63000, rate: 0.00, baseAmount: 0 },
      { lowerBound: 63000, upperBound: 551350, rate: 0.15, baseAmount: 0 },
      { lowerBound: 551350, upperBound: null, rate: 0.20, baseAmount: 0 },
    ],
    qualifying_surviving_spouse: [
      { lowerBound: 0, upperBound: 94050, rate: 0.00, baseAmount: 0 },
      { lowerBound: 94050, upperBound: 583750, rate: 0.15, baseAmount: 0 },
